...
export const exclusivites: Product[] = [
  ...
  { id:"e23", slug:"dragon-green", name:"Dragon", artist:"Richard Orlinski", coloris:"Green Edition", description:"Le dragon d'Orlinski dans sa version verte — mythologie et géométrie.", longDescription:"Le Dragon Green Edition d'Orlinski convoque les mythologies du monde entier dans un langage plastique résolument contemporain. Le vert profond évoque les écailles des dragons des légendes orientales, tandis que la géométrie tranchante des facettes lui confère une modernité absolue.", available:true, images:["/products/dragon-green1.png","/products/dragon-green2.png"], specs:{ Matière:"Résine haute qualité", Finition:"Vert brillant", Édition:"Exclusivité Kessef Art" }, category:"Exclusivités" },
  { id:"e24", slug:"kong-kase-silver", name:"Kong Kase", artist:"Richard Orlinski", coloris:"Silver Edition", description:"La valise Kong en argent — un accessoire de voyage d'exception.", longDescription:"Le Kong Kase Silver Edition est la valise des voyageurs qui refusent l'anonymat. Ornée du Kong en relief argent, elle impose une présence immédiate dans n'importe quel aéroport du monde.", available:true, images:["/products/kong-kase-silver1.png","/products/kong-kase-silver2.png"], specs:{ Format:"Valise cabine", Matière:"ABS haute résistance", Finition:"Silver — Kong en relief" }, category:"Exclusivités" },
...
export const livres: Product[] = [
  ...
  { id:"l6", slug:"cahier-coloriage-kids", name:"Cahier de Coloriage", artist:"Richard Orlinski", coloris:"Art for Kids", description:"L'art Orlinski pour les enfants — découvrir la sculpture contemporaine en coloriant.", longDescription:"Le Cahier de Coloriage Art for Kids initie les plus jeunes à l'univers de Richard Orlinski de façon ludique et créative. Les sculptures géométriques adaptées aux enfants développent la sensibilité artistique.", available:true, images:["/products/cahier-coloriage-kids1.png","/products/cahier-coloriage-kids2.png"], specs:{ Format:"A4 — papier épais", Public:"Enfants 4-12 ans", Contenu:"Illustrations exclusives" }, category:"Livres" },
];

// ── Best Sellers ───────────────────────────────────────────────────────────

export const bestSellers: Product[] = [
  { id:"b1", slug:"porte-cles-kong-spirit", name:"Porte-Clés Kong Spirit", artist:"Richard Orlinski", coloris:"Multicolore", description:"Le Kong en porte-clés — la signature Orlinski à portée de main au quotidien.", longDescription:"Le Porte-Clés Kong Spirit transporte l'univers d'Orlinski dans les gestes du quotidien. Fidèle à la sculpture originale dans un format miniature, il est l'accessoire idéal pour les amateurs d'art.", available:true, images:["/products/porte-cles-kong-spirit1.png","/products/porte-cles-kong-spirit2.png"], specs:{ Matière:"Résine et métal", Format:"Porte-clés collector", Livraison:"Coffret cadeau" }, category:"Best Sellers" },
...
export const divers: Product[] = [
  ...
  { id:"v2", slug:"drap-de-plage", name:"Drap de Plage", artist:"Richard Orlinski", coloris:"Collection Summer", description:"Le drap de plage Orlinski — la collection summer signée par l'artiste.", longDescription:"Le Drap de Plage Collection Summer d'Orlinski transforme la serviette de plage en accessoire de mode. Imprimé de motifs exclusifs créés par l'artiste, il allie praticité et esthétique.", available:true, images:["/products/drap-de-plage1.png","/products/drap-de-plage2.png"], specs:{ Matière:"Coton éponge", Dimensions:"90 x 170 cm", Collection:"Summer Orlinski" }, category:"Divers" },
  { id:"v3", slug:"sac-de-plage", name:"Sac de Plage", artist:"Richard Orlinski", coloris:"Collection Summer", description:"Le sac de plage Orlinski — emportez l'art avec vous.", longDescription:"Le Sac de Plage Collection Summer complète parfaitement la collection estivale d'Orlinski. Spacieux et résistant, il est orné de motifs exclusifs créés par l'artiste.", available:true, images:["/products/sac-de-plage1.png","/products/sac-de-plage2.png"], specs:{ Matière:"Toile résistante", Fermeture:"Zip sécurisé", Collection:"Summer Orlinski" }, category:"Divers" },
  { id:"v4", slug:"raquettes-de-plage", name:"Raquettes de Plage", artist:"Richard Orlinski", coloris:"Collection Summer", description:"Les raquettes de plage Orlinski — le jeu devient art.", longDescription:"Les Raquettes de Plage Collection Summer transforment un jeu estival ordinaire en expérience esthétique. Ornées du design exclusif d'Orlinski, elles sont autant des accessoires de jeu que des objets de décoration.", available:true, images:["/products/raquettes-de-plage1.png","/products/raquettes-de-plage2.png"], specs:{ Matière:"Bois et fibre synthétique", Contenu:"Set de 2 raquettes + balle", Collection:"Summer Orlinski" }, category:"Divers" },
